...
namespace CocKleBursTransport.Transporting.EOSPlugin
{
    ...
    public class NetickEOS : MonoBehaviour
    {
        ...
        public static NetickEOS Instance
        {
            get
            {
                if (!_instance)
        ...
        [SerializeField] private string socketName = "EOS";
        ...
        public  LocalConnectionState GetConnectionState(bool server)
        {
            if (server)
        ...
        /// </summary>
        public  event Action<ClientReceivedDataArgs> OnClientReceivedData;

        /// <summary>
        /// Handles a ClientReceivedDataArgs.
        /// </summary>
        /// <param name="receivedDataArgs"></param>
        public  void HandleClientReceivedDataArgs(ClientReceivedDataArgs receivedDataArgs)
        {
            OnClientReceivedData?.Invoke(receivedDataArgs);
        }

        /// <summary>Called when server receives data.</summary>
        public  event Action<ServerReceivedDataArgs> OnServerReceivedData;

        /// <summary>
        /// Handles a ClientReceivedDataArgs.
        /// </summary>
        /// <param name="receivedDataArgs"></param>
        public  void HandleServerReceivedDataArgs(ServerReceivedDataArgs receivedDataArgs)
        {
        ...
        /// EOS Not Used
        /// </summary>
        public void SetServerBindAddress(string address, IPAddressType addressType)
        {
            _ = address;
        }
        ...
        public bool StartConnection(bool server)
        {
            if (server)
                return StartServer();
            else
        ...
        public bool StopConnection(bool server)
        {
            if (server)
                return StopServer();
            else
